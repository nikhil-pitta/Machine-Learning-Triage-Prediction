...
public class Triage5 extends JFrame {
	...
	private void createComponenets() 
	{
		...
		lblTriage = new JLabel("Triage 5");
		lblTriage.setFont(new Font("Lucida Grande", Font.PLAIN, 24));
		btnGoBack = new JButton("Go Back");
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("/Users/nikhil/Desktop/Synopsys Project/TriageTable5.png"));
