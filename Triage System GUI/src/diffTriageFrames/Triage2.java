...
public class Triage2 extends JFrame {
...
public Triage2() {
	...
	private void createComponenets() 
	{
		...
		lblTriage = new JLabel("Triage 2");
		lblTriage.setFont(new Font("Lucida Grande", Font.PLAIN, 24));
		btnGoBack = new JButton("Go Back");
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("/Users/nikhil/Desktop/Synopsys Project/TriageTable2.png"));
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addComponent(lblTriage, GroupLayout.PREFERRED_SIZE, 105, GroupLayout.PREFERRED_SIZE)
					.addGap(235))
		);
