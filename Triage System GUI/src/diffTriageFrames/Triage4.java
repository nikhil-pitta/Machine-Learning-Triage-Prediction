...
public class Triage4 extends JFrame {
	...
	private void createComponenets() 
	{
		...
		lblTriage = new JLabel("Triage 4");
		lblTriage.setFont(new Font("Lucida Grande", Font.PLAIN, 24));
		btnGoBack = new JButton("Go Back");
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setIcon(new ImageIcon("/Users/nikhil/Desktop/Synopsys Project/TriageTable4.png"));
		...
		gl_contentPane.setHorizontalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				...
				.addGroup(Alignment.LEADING, gl_contentPane.createSequentialGroup()
					.addGap(256)
					.addComponent(lblTriage, GroupLayout.PREFERRED_SIZE, 126, GroupLayout.PREFERRED_SIZE)
